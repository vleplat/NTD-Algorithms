...
input nonnegative Tensor ![\Large \mathcal{X} \in \mathbb{R}_+^{I_1 \times \ ldots I_N}](https://latex.codecogs.com/svg.latex?\Large&space;\mathcal{X} \in \mathbb{R}_+^{I_1 \times \ ldots I_N}).
