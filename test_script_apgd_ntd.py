...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    # ### APGD No HER
    core_NoHER_APGD, factors_NoHER_APGD, cost_fct_vals_NoHER_APGD, toc_NoHER_APGD, alpha_NoHerAPGD = APGD.ntd_apgd(T, ranks, init = "custom", core_0 = core_0, factors_0 = factors_0, n_iter_max = 500, beta = 2,
    ...
    # ### APGD HER
    core_HER_APGD, factors_HER_APGD, cost_fct_vals_HER_APGD, toc_HER_APGD, alpha_APGD = APGD.ntd_apgd(T, ranks, init = "custom", core_0 = core_0, factors_0 = factors_0, n_iter_max = 500, beta = 2,
                                                sparsity_coefficients = [None, None, None, None], fixed_modes = [], normalize = [False, False, False, False],
                                                verbose = True, return_costs = True, extrapolate=True)
    
    # ### Beta = 2 - MU no extrapolation
    core, factors, cost_fct_vals, toc = NTD.ntd_mu(T, ranks, init = "custom", core_0 = core_0, factors_0 = factors_0, n_iter_max = 500, tol = 1e-6, beta = 2,
                                                sparsity_coefficients = [None, None, None, None], fixed_modes = [], normalize = [False, False, False, False],
                                                verbose = True, return_costs = True, extrapolate=False)
